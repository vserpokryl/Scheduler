!function(t) {
    ...
    "use strict";
    var o = n(0), r = n(68), i = n(71), s = n(77), a = n(75), c = n(39), btoa = "undefined" != typeof window && window.btoa && window.btoa.bind(window) || n(70);
    t.exports = function(t) {
        return new Promise(function(e, u) {
            var l = t.data, f = t.headers;
            o.isFormData(l) && delete f["Content-Type"];
            var p = new XMLHttpRequest(), d = "onreadystatechange", h = !1;
            if ("undefined" == typeof window || !window.XDomainRequest || "withCredentials" in p || a(t.url) || (p = new window.XDomainRequest(), 
            d = "onload", h = !0, p.onprogress = function() {}, p.ontimeout = function() {}), 
            t.auth) {
            ...
            p.timeout = t.timeout, p[d] = function() {
                if (p && (4 === p.readyState || h) && (0 !== p.status || p.responseURL && 0 === p.responseURL.indexOf("file:"))) {
                    var n = "getAllResponseHeaders" in p ? s(p.getAllResponseHeaders()) : null, o = t.responseType && "text" !== t.responseType ? p.response : p.responseText, i = {
                        data: o,
                ...
                var g = n(73), y = (t.withCredentials || a(t.url)) && t.xsrfCookieName ? g.read(t.xsrfCookieName) : void 0;
    ...
    var o = n(1), r = n(20), i = n(91), s = n(5), a = function(t, e, n) {
    ...
    "use strict";
    var o = n(24), r = n(43), i = n(50), s = n(5), a = n(2), c = n(23), u = n(96), l = n(26), f = n(103), p = n(7)("iterator"), d = !([].keys && "next" in [].keys()), h = function() {
        return this;
    };
    ...
    var o = n(11), r = n(100), i = n(22), s = n(27)("IE_PROTO"), a = function() {}, c = function() {
        var t, e = n(42)("iframe"), o = i.length;
    ...
    function btoa(t) {
        for (var e, n, i = String(t), s = "", a = 0, c = r; i.charAt(0 | a) || (c = "=", 
    ...
    q || (j = function() {
        ...
        return this._k;
    }), k.f = J, $.f = Q, n(47).f = _.f = G, n(25).f = Y, n(48).f = Z, i && !n(24) && a(B, "propertyIsEnumerable", Y, !0), 
    h.f = function(t) {
        return z(d(t));
    }), s(s.G + s.W + s.F * !q, {
        Symbol: j
    ...
    }), j.prototype[I] || n(5)(j.prototype, I, j.prototype.valueOf), f(j, "Symbol"), 
